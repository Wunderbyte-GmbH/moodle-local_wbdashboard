...
final class chart_definition_test extends \advanced_testcase {
    public function test_colour_args_are_ignored(): void {
        $definition = chart_definition::from_shortcode_args([
    ...
    public function test_chartid_is_deterministic(): void {
        ...
        $a = chart_definition::from_shortcode_args($args)->chartid_base(42);
        $b = chart_definition::from_shortcode_args($args)->chartid_base(42);
    ...
    public function test_chartid_namespaced_by_context(): void {
        $args = ['source' => 'reportbuilder', 'type' => 'bar', 'report' => '3'];
        $incontext1 = chart_definition::from_shortcode_args($args)->chartid_base(1);
        $incontext2 = chart_definition::from_shortcode_args($args)->chartid_base(2);
    ...
    public function test_chartid_ignores_cosmetic_opts(): void {
        ...
        $plain = chart_definition::from_shortcode_args($base)->chartid_base(7);
        $decorated = chart_definition::from_shortcode_args(
    ...
    public function test_chartid_changes_with_data_params(): void {
        $three = chart_definition::from_shortcode_args(
            ['source' => 'reportbuilder', 'type' => 'bar', 'report' => '3']
        )->chartid_base(7);
        $four = chart_definition::from_shortcode_args(
